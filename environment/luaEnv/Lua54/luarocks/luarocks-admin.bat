...
SET "LUA_PATH=C:\luaEnv\Lua54\luarocks\lua\?.lua;C:\luaEnv\Lua54\luarocks\lua\?\init.lua;%LUA_PATH%"
IF NOT "%LUA_PATH_5_2%"=="" (
   SET "LUA_PATH_5_2=C:\luaEnv\Lua54\luarocks\lua\?.lua;C:\luaEnv\Lua54\luarocks\lua\?\init.lua;%LUA_PATH_5_2%"
)
IF NOT "%LUA_PATH_5_3%"=="" (
   SET "LUA_PATH_5_3=C:\luaEnv\Lua54\luarocks\lua\?.lua;C:\luaEnv\Lua54\luarocks\lua\?\init.lua;%LUA_PATH_5_3%"
)
SET "PATH=C:\luaEnv\Lua54\luarocks;%PATH%"
"C:\LuaEnv\lua54\lua54.exe" "C:\luaEnv\Lua54\luarocks\luarocks-admin.lua" %*
